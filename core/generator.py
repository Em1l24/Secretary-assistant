...
class DocumentGenerator:
    ...
    def _generate_vkr_documents(self, temp_dir, commission, chairman_reversed, secretary_reversed):
        ...
        book_context = {'direction_2': book_data.get('direction'), 'date_2': book_data.get('date'), 'status': commission.get('secretary_position'), 'secretary_3': commission.get('secretary')}
        ...
        for i, student in enumerate(students, start=5):
            ...
            context = {
                'protocol_2': student.get('protocol'), 'direction_2': student.get('direction'), 'date_2': student.get('date'),
                ...
                'dategek_2': student.get('dategek'), 'leader': leader_to_genitive(student.get('leader')) if student.get('leader') else "",
                'post': student.get('post'), 'con': student.get('con'), 'order': student.get('order'),
                ...
                'quali': student.get('quali'), 'diplom': student.get('diplom'), 'tom': student.get('tom'),
    ...
    def _generate_gos_documents(self, temp_dir, commission, chairman_reversed, secretary_reversed):
        ...
        if test_students or exam_students:
            ...
            book_context = {
                'direction_1': book_data.get('direction'),
                'date_1': book_data.get('date'),
        ...
        for i, student in enumerate(test_students, start=4):
            ...
            if not fio:
                continue
            context = {
                'protocol': student.get('protocol'), 'direction': student.get('direction'), 'date': student.get('date'),
                'chairman': commission.get('chairman'), 'position': commission.get('chairman_position'),
                'member_1': commission.get('member_1', ''), 'position_1': commission.get('member_1_position', ''),
                'member_2': commission.get('member_2', ''), 'position_2': commission.get('member_2_position', ''),
                'member_3': commission.get('member_3', ''), 'position_3': commission.get('member_3_position', ''),
                'member_4': member_4, 'position_4': position_4,
                'secretary_1': secretary_reversed, 'secretary_2': secretary_reversed, 'secretary_3': commission.get('secretary'),
                'dategek': student.get('dategek'), 'group': student.get('group'), 'initials_gen': to_accusative(fio),
                'property': student.get('property'), 'initials': normalize_fio(fio), 'mark': student.get('mark'),
                'chairman_1': chairman_reversed
            }
        ...
        for i, student in enumerate(exam_students, start=4):
            ...
            if not fio:
                continue
            context = {
                'protocol_1': student.get('protocol'), 'direction_1': student.get('direction'), 'date_1': student.get('date'),
                'chairman': commission.get('chairman'), 'position': commission.get('chairman_position'),
                'member_1': commission.get('member_1', ''), 'position_1': commission.get('member_1_position', ''),
                'member_2': commission.get('member_2', ''), 'position_2': commission.get('member_2_position', ''),
                'member_3': commission.get('member_3', ''), 'position_3': commission.get('member_3_position', ''),
                'member_4': member_4, 'position_4': position_4,
                'secretary_1': secretary_reversed, 'secretary_2': secretary_reversed, 'secretary_3': commission.get('secretary'),
                'dategek_1': student.get('dategek'), 'group_1': student.get('group'), 'initials_gen_1': to_accusative(fio),
                'ticket': student.get('ticket'), 'state_date': student.get('state_date'), 'questions': student.get('questions'),
                'add_questions': student.get('add_questions'), 'property_1': student.get('property'),
                'initials_1': normalize_fio(fio), 'mark_1': student.get('mark'), 'chairman_1': chairman_reversed
            }
